...
namespace SanteDB.Messaging.RISI.Client
{
    /// <summary>
    ...
    public class RisiServiceClient : ServiceClientBase, IDisposable
    {
        ...
        {
            return this.Client.Post<DatamartDefinition, DatamartDefinition>("datamart", definition);
        }
        ...
        {
            return this.Client.Post<ParameterType, ParameterType>("type", parameterTypeDefinition);
        }
        ...
        {
            return this.Client.Post<ReportDefinition, ReportDefinition>("report", reportDefinition);
        }
        ...
        {
            return this.Client.Put<ParameterType, ParameterType>($"type/{id}", parameterTypeDefinition);
        }
        ...
        {
            return this.Client.Put<ReportDefinition, ReportDefinition>($"report/{id}", reportDefinition);
        }
